...
# Objects & Arrays
function napi_value(d::AbstractDict)
...
function get_info(arr::NapiValue, array_type=:typedarray)
    data = Ref{Ptr{Cvoid}}()
...
is_buffer(v::NapiValue) = @napi_call napi_is_buffer(v::NapiValue)::Bool
is_dataview(v::NapiValue) = @napi_call napi_is_dataview(v::NapiValue)::Bool
is_promise(v::NapiValue) = @napi_call napi_is_promise(v::NapiValue)::Bool
