...
napi_value(s::AbstractString) = @napi_call napi_create_string_utf8(s::Cstring, ncodeunits(s)::Csize_t)::NapiValue
...
#     @napi_call node_api_symbol_for(ss::Cstring, ncodeunits(ss)::Csize_t)::NapiValue
# end
